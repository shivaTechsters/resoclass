...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.registration.import') }}">Import Data</a></li>
        </ul>
        <h1 class="panel-title">Import Data</h1>
    </div>
@endsection

@section('panel-body')
    <form action="{{ route('admin.handle.registration.import') }}" method="POST" enctype="multipart/form-data">
        @csrf
